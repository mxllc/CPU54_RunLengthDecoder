...
#
# Generated by export_simulation on Sat Jun 16 15:49:51 +0800 2018
#
################################################################################
...
switch to the './dist_iram_ip.sh' script.

./dist_iram_ip.sh -reset_run
...
./dist_iram_ip.sh -noclean_files

For more information on the script, please type './dist_iram_ip.sh -help'.
