...
HD_PWD='L:/CPU54/CPU54.runs/dist_iram_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_iram_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_iram_ip.tcl
